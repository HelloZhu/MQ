...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [NSObject exchangeInstanceMethodWithSelfClass:NSClassFromString(@"__NSPlaceholderArray") originalSelector:NSSelectorFromString(@"initWithObjects:count:") swizzledSelector:@selector(safe_initWithObjects:count:)];
...
- (instancetype)safe_initWithObjects:(id  _Nonnull const [])objects count:(NSUInteger)cnt
{
    ...
    return [self safe_initWithObjects:objects count:rightCount];
}
